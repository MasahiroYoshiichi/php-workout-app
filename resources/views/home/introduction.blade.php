...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-7 d-block d-md-none pt-4 a-cours">
            <h2>アスリートコース</h2>
            <br>
             <p>このコースでは、高負荷かつ持久力が鍛えられるトレーニングを<br>提供しています。</p>
             <p>スポーツをされている方や日常的にトレーニングをされている方に<br>お薦めできます。</p>
             <p>内容はウエイトトレーニングと自重トレーニングをミックスした<br>ハイブリッドトレーニングになります。</p>
        ...
        <div class="col-md-7 d-block d-md-none pt-4 e-cours">
            <h2>エクササイズコース</h2>
            <br>
            <p>このコースでは、中負荷~低負荷を中心とした心地いいトレーニングを<br>提供しています。</p>
            <p>スポーツ経験者、活動的な方にお薦めできます。</p>
            <p>内容は中負荷~低負荷の自重トレーニングとダンベルトレーニングが<br>メインになります。</p>
        ...
        <div class="col-md-7  d-block d-md-none pt-4 f-cours">
            <h2>フィットネスコース</h2>
            <br>
            <p>このコースでは、低負荷なトレーニングを中心とした、<br>誰でも始めやすいトレーニングを提供しています。</p>
        ...
        <div class="col-md-7  d-none d-md-block pt-4 f-cours">
            ...
            <p>生活に運動を取り入れたい方、健康を意識されている方にお薦めできます。</p>
