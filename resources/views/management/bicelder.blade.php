...
<div class="d-none d-md-block card text-dark training-point-card">
     <div class="card-header bicelder-card-header">上腕二頭筋のトレーニング管理</div>
  　 <div class="card-body bicelder-point-card-body">
 ...
 <div class="d-block d-md-none card text-dark">
     <div class="card-header bicelder-card-header">上腕二頭筋のトレーニング管理</div>
  　 <div class="card-body bicelder-point-card-body-sm">
