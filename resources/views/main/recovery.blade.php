...
<div class="container-fluid bg-secondary">
    ...
    <div class="row recovery-pru justify-content-center text-center">
        <div class="dropdown">
           <button class="btn btn-light btn-lg recovery_botton dropdown-toggle" type="button" id="team_id" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
           筋力アップ
           </button>
    ...
    <div class="row">
        <div class="col-md-2 pt-3 pb-5  text-center recovery_list overflow-auto" style="height:600px;">
