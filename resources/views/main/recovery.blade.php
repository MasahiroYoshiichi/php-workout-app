...
<div class="container-fluid bg-light">
    ...
    <div class="col-6 mx-auto">
            <button class="btn btn-dark btn-lg recovery_botton_sm dropdown-toggle d-block d-md-none" type="button" id="team_id" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              栄養素一覧
            </button>
            <div class="dropdown-menu overflow-auto" style="height:460px;" aria-labelledby="dropdownMenuButton">
               ...
               <button class="dropdown-item click" data-id="polyphenol">ポリフェノール</button>
    ...
    <div class="row recovery-pru justify-content-center text-center">
        <div class="dropdown">
           <button class="btn btn-dark btn-lg recovery_botton dropdown-toggle d-none d-md-block" type="button" id="team_id" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="margin-left:15rem;">
           筋力アップ
           </button>
           <button class="btn btn-dark recovery_botton_sm dropdown-toggle d-block d-md-none" type="button" id="team_id" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
           筋力アップ
           </button>
        ...
        <div class="dropdown">
           <button class="btn btn-dark ml-5 btn-lg recovery_botton dropdown-toggle d-none d-md-block" type="button" id="team_id" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
           ダイエット＆美容
           </button>
           <button class="btn btn-dark recovery_botton_sm dropdown-toggle d-block d-md-none" type="button" id="team_id" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
           ダイエット＆美容
